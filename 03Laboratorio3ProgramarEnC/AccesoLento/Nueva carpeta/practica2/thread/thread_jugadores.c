...
void* jugadoresThread(void* parametro)
{
  ...
  intervalo = 0; /*obtenerIntervaloJugador(datosThread->nroJugador);*/
  ...
  while(msg.intEvento != EVT_FIN)
  {
    ...
    switch(msg.intEvento)
    {
      ...
      case EVT_CAMINAR:
        /*
        do {
          printf("juntar 0-1-3-4-5:\n");
          scanf("%s", juntar);
        } while(juntar != "piedra" );
        */

        /*cantidad aleatoria a juntar*/
