/*
Se ingresa el número de cuenta, el saldo de caja de ahorro y el saldo de cuenta corriente de clientes de un banco. Cargar una lista con estos datos. La carga de datos finaliza cuando el número de cuenta del cliente es cero. 
    ...
    c) Ingresar los datos de un nuevo cliente e insertarlo manteniendo el orden de la lista.
*/
